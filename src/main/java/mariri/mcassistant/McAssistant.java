...
@Mod(modid = McAssistant.MODID, name = McAssistant.NAME, version = McAssistant.VERSION, acceptableRemoteVersions = "*")
public class McAssistant {

        public static final String MODID = "mcassistant";
        public static final String NAME = "McAssistant";
        public static final String VERSION = "1.11.2-1.0a";
        	...
        	try{
	        	for(String value : registOreDictionaryList){
	    			if(!"".equals(value)){
	        			...
	        			ItemStack item = GameRegistry.makeItemStack(modid + ":" + name, 0, 1, null);
